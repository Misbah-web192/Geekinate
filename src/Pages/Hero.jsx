    ...
    <>
      <section id='hero' className=' flex flex-col sm:flex-col md:flex-row  pt-60 px-10  gap-11 justify-center items-center'>
        <div data-aos="fade-up"  data-aos-easing="ease-in-out"
          ...
          <button className='text-white mt-5 py-2.5 px-5 font-bold rounded-md shadow-md shadow-[rgb(213,237,219)] bg-[rgb(223,13,163)]' data-aos="fade-up" data-aos-delay="400" data-aos-easing="ease-in-out"
